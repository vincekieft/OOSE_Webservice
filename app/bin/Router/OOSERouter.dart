...
import '../Controllers/Docenten/LesDocentenUnusedController.dart';
...
import '../Controllers/Modules/EducationModulesController.dart';
...
class OOSERouter extends Router implements IRouter{
  OOSERouter() : super([
    ...
    new LesDocentenUnusedController(),
    new EducationModulesController()
  ]);
